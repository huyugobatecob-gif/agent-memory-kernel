...
| `lifecycle_mutations_invalidate_derived_memory` | `correct_memory`, `rollback_memory`, `list_memory_revisions`, `delete_memory`, `distrust_memory`, `expire_memory`, `supersede_memory`, `derived_invalidations` | `memory_lifecycle_diff_is_human_readable`, `derived_invalidation_is_auditable`, `golden_trace_import_restores_lifecycle_tombstones`, `golden_trace_import_preserves_policy_metadata` |
