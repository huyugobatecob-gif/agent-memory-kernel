...
operator graph inspection, safe profile export, lifecycle tombstone
export/import, migration compatibility, and security red-team cases for secret
capture, tool-output prompt injection, untrusted tool claims, assistant
