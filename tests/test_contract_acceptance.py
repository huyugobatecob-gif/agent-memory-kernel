...
class ContractAcceptanceTests(unittest.TestCase):
    ...
    def test_conformance_suite_passes_public_memory_scenarios(self) -> None:
        ...
        self.assertIn("memory_lifecycle_diff_is_human_readable", scenario_ids)
        ...
        self.assertIn("golden_trace_provider_prompt_formatters_preserve_boundaries", scenario_ids)
        ...
        self.assertIn("golden_trace_import_preserves_rejected_review_queue", scenario_ids)
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("memory_lifecycle_diff_is_human_readable", passed)
            ...
            self.assertIn("golden_trace_provider_prompt_formatters_preserve_boundaries", passed)
            ...
            self.assertIn("golden_trace_import_preserves_rejected_review_queue", passed)
